...
export const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  return (
    <div className="relative w-full rounded-3xl glass-card p-6 sm:p-8 overflow-hidden group">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-6 sm:gap-8">
        ...
        <div className="flex flex-col items-center shrink-0">
          <div className="relative group/avatar">
            <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-3xl overflow-hidden border-2 border-white/20 shadow-2xl bg-slate-900 flex items-center justify-center transition-transform duration-300 group-hover/avatar:scale-102">
              {profile.avatarUrl ? (
                <img
        ...
        <div className="flex-1 text-center md:text-left">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-2">
            <div>
              <div className="flex items-center justify-center md:justify-start gap-2.5">
                ...
                <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-emerald-500/15 border border-emerald-500/30 text-emerald-300">
                  Online
                </span>
              </div>
              <p className="text-indigo-400 font-medium text-sm mt-0.5 font-sans">
                {profile.title}
              </p>
            </div>
            ...
            <button
              ...
              className="self-center md:self-start px-3.5 py-1.5 rounded-xl glass-button-secondary text-xs font-medium flex items-center gap-1.5 transition-colors"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 mb-5">
            <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/5 border border-white/5 text-xs text-slate-300">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 pt-2 border-t border-white/5">
            {profile.socialLinks.github && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-3 py-1.5 rounded-lg glass-pill text-xs text-slate-300 hover:text-white flex items-center gap-1.5 transition-colors"
              >
