        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 rounded-xl glass-pill text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white text-xs font-medium transition-all group cursor-pointer"
            ...
            <button
              onClick={onOpenTheme}
              className="p-2 sm:px-3 sm:py-2 rounded-xl glass-pill text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white text-xs font-medium flex items-center gap-1.5 transition-all cursor-pointer"
